...
interface EnrollNowButtonProps extends React.ButtonHTMLAttributes<HTMLButtonElement> {}

const EnrollNowButton: React.FC<EnrollNowButtonProps> = (props) => {
  return (
    <StyledWrapper>
      <button {...props} className={`button ${props.className || ''}`} type={props.type || 'button'}>
        <div className="bg" />
...
const StyledWrapper = styled.div`
  ...
  .button {
    ...
    width: 220px;
    height: 80px;
    /* Removed the rotation and skew to make it perfectly horizontal, scaled down by 0.8 */
    transform: scale(0.8); 
  ...
  .bg::before {
    ...
    /* Neumorphic soft shadows: outer drop shadow and lighter glow combination */
    box-shadow:
      6px 6px 14px 0px rgba(45, 15, 66, 0.7), 
      -6px -6px 14px 0px rgba(239, 182, 255, 0.25);
  }
  ...
  .wrap {
    ...
    overflow: hidden;
    height: 100%;
    transform: translate(0px, 0px); /* Tamed initial displacement for cleaner layout alignment */
    padding: 3px;
  ...
  .content {
    ...
    /* Soft internal Neumorphic indentions */
    box-shadow:
      inset 3px 3px 6px 0px rgba(0, 0, 0, 0.25),
      inset -3px -3px 6px 0px rgba(255, 255, 255, 0.2);
  }
  .content::before {
    content: "";
    inset: 0;
  ...
  /* Smooth hover translation profile */
  .button:hover .wrap {
    transform: translate(2px, -2px);
  }
  
  /* Elevate neumorphic shadow state slightly on hover */
  .button:hover .bg::before {
    box-shadow:
      9px 9px 20px 0px rgba(45, 15, 66, 0.85), 
      -9px -9px 20px 0px rgba(239, 182, 255, 0.35);
  }
  ...
  /* Compress the shadow depth on active press to look responsive */
  .button:active .bg::before {
    filter: blur(2px);
    opacity: 0.9;
    box-shadow:
      2px 2px 5px 0px rgba(45, 15, 66, 0.8), 
      -2px -2px 5px 0px rgba(239, 182, 255, 0.2);
  }
  .button:active .content {
    box-shadow:
      inset 5px 5px 10px 0px rgba(0, 0, 0, 0.4),
      inset -5px -5px 10px 0px rgba(255, 255, 255, 0.1);
  }
